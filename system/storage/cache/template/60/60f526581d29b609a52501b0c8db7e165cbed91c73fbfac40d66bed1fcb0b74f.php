...
class __TwigTemplate_da04a13351d62321ba0325f4412997cce66a08e534a45c9e70125ebe5cbbf7ab extends \Twig\Template
{
    private $source;
    private $macros = [];
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["card"]) {
                ...
                echo "                            <li class=\"giftCards-cards__item\">
                                <picture>
                                    <source srcset=\"";
                // line 49
                echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["card"], "thumb", [], "any", false, false, false, 49), "webp", [], "any", false, false, false, 49);
                echo "\">
                                    <img class=\"category_underCategories-img\" src=\"";
                // line 50
                echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["card"], "thumb", [], "any", false, false, false, 50), "default", [], "any", false, false, false, 50);
                echo "\"
                                         loading=\"lazy\">
                                </picture>
