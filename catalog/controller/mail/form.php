    ...
    private function validate()
    {
        ...
        if (isset($this->request->post['name'])) {
            if ((utf8_strlen($this->request->post['name']) < 3) || (utf8_strlen($this->request->post['name']) > 32)) {
                $this->error['name'] = 'Имя должно быть от 3 до 32 символов!';
            }
        };

        if (isset($this->request->post['email'])) {
            if ((utf8_strlen($this->request->post['email']) < 3) || (utf8_strlen($this->request->post['email']) > 32)) {
                $this->error['email'] = 'Email должен быть от 3 до 32 символов!';
            }
        };

        if (isset($this->request->post['phone'])) {
            if ((utf8_strlen($this->request->post['phone']) < 10) || (utf8_strlen($this->request->post['phone']) > 24)) {
                $this->error['phone'] = 'Телефон должен быть от 10 до 24 символов!';
            }
        };
