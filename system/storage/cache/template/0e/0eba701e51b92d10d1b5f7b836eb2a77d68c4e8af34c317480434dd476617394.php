...
class __TwigTemplate_efd3d08220355c00a8992d4714fb8923254babfde2742bbe11b6c24ad5b24173 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<div id=\"product-product\">
    ...
    ";
        ...
        if (($context["recently_viewed_products"] ?? null)) {
            // line 408
            echo "        <section class=\"product-recentlyViewed\">
            <div class=\"container\">
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["recently_viewed_product"]) {
                                ...
                                <div class=\"products_grid-thumb\">
                                    <div class=\"products_grid-block\">
                                        <picture>
                                            <source srcset=\"";
                // line 418
                echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "thumb", [], "any", false, false, false, 418), "webp", [], "any", false, false, false, 418);
                echo "\">
                                            <img class=\"catalog-inner_link-img\" alt=\"";
                // line 419
                echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "name", [], "any", false, false, false, 419);
                echo "\"
                                                 title=\"";
                // line 420
                echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "name", [], "any", false, false, false, 420);
                echo "\"
                                                 src=\"";
                // line 421
                echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "thumb", [], "any", false, false, false, 421), "default", [], "any", false, false, false, 421);
                echo "\" loading=\"lazy\">
                                        </picture>
                                        <p class=\"products_grid-price\">
                                            ";
                // line 424
                if ( !twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "special", [], "any", false, false, false, 424)) {
                    // line 425
                    echo "                                                <span
                                                        class=\"price-new\">";
                    // line 426
                    echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "price", [], "any", false, false, false, 426);
                    echo "</span>
                                            ";
                } else {
                    // line 428
                    echo "                                                <span
                                                        class=\"price-new\">";
                    // line 429
                    echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "special", [], "any", false, false, false, 429);
                    echo "</span>
                                                <span
                                                        class=\"price-old\">";
                    // line 431
                    echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "price", [], "any", false, false, false, 431);
                    echo "</span>
                                                <span class=\"price-percent\">";
                    // line 432
                    echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "percent", [], "any", false, false, false, 432);
                    echo "</span>
                                            ";
                }
                // line 434
                echo "                                        </p>
                                    ...
                                    <h4 class=\"products_grid-title\">";
                // line 436
                echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "name", [], "any", false, false, false, 436);
                echo "</h4>
                                    <button class=\"products_grid-wishlist\" type=\"button\" data-toggle=\"tooltip\"
                                            title=\"";
                // line 438
                ...
                echo "\"
                                            onclick=\"wishlist.add('";
                // line 439
                echo twig_get_attribute($this->env, $this->source, ($context["product"] ?? null), "product_id", [], "any", false, false, false, 439);
                echo "');\">
                                        <svg class=\"icon-svg-whishlist\" xmlns=\"http://www.w3.org/2000/svg\">
                                            <use xlink:href=\"/sprite.svg#icon_heart\"></use>
                                        </svg>
