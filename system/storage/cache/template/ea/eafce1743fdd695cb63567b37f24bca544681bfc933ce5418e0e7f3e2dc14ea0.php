...
class __TwigTemplate_82b0cd7e5cbf0971cf01c2e25c52676597a09bf7e3828447532b064b0ebe19e0 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t<li class=\"footer-grid_item-list_link\">© ";
        // line 69
        echo ($context["year"] ?? null);
        echo " Dreams Store</li>
\t\t\t\t\t\t<li class=\"footer-grid_item-list_link\"><a>Карта сайта</a></li>
\t\t\t\t\t\t<li class=\"footer-grid_item-list_linkk\"><a>Политика конфиденциальности</a></li>
\t\t\t\t\t\t<li class=\"footer-grid_item-list_link\"><a>Разработка сайта: <img src=\"";
        // line 72
        echo $this->env->getAssets();
...
\t\t\t\t\t<ul class=\"footer-grid_item-list\">
\t\t\t\t\t\t<li class=\"footer-grid_item-list_item\">Оплата и доставка</li>
\t\t\t\t\t\t<li class=\"footer-grid_item-list_item\">Гарантия и возврат</li>
\t\t\t\t\t\t<li class=\"footer-grid_item-list_item\">Как выбрать ткань</li>
\t\t\t\t\t\t<li class=\"footer-grid_item-list_item\">Частые вопросы</li>
\t\t\t\t\t\t<li class=\"footer-grid_item-list_item\">Советы по уходу</li>
\t\t\t\t\t\t<li class=\"footer-grid_item-list_item\">Отзывы</li>
\t\t\t\t\t\t<li class=\"footer-grid_item-list_item\">Блог</li>
\t\t\t\t\t</ul>
\t\t\t\t</div>
\t\t\t\t<div class=\"footer-grid_item\">
\t\t\t\t\t<h4 class=\"footer-grid_item-title\">Каталог</h4>
\t\t\t\t\t<ul class=\"footer-grid_item-list\">
\t\t\t\t\t\t<li class=\"footer-grid_item-list_item\">Постельное белье</li>
\t\t\t\t\t\t<li class=\"footer-grid_item-list_item\">Подушки</li>
\t\t\t\t\t\t<li class=\"footer-grid_item-list_item\">Одеяла</li>
\t\t\t\t\t\t<li class=\"footer-grid_item-list_item\">Шторы</li>
\t\t\t\t\t\t<li class=\"footer-grid_item-list_item\">Покрывала</li>
\t\t\t\t\t\t<li class=\"footer-grid_item-list_item\">Полотенца</li>
\t\t\t\t\t\t<li class=\"footer-grid_item-list_item\">Одежда для дома</li>
\t\t\t\t\t</ul>
\t\t\t\t</div>
\t\t\t\t<div class=\"footer-grid_item\">
\t\t\t\t\t<h4 class=\"footer-grid_item-title\">Сервисы</h4>
\t\t\t\t\t<ul class=\"footer-grid_item-list\">
\t\t\t\t\t\t<li class=\"footer-grid_item-list_item\">Ателье</li>
\t\t\t\t\t\t<li class=\"footer-grid_item-list_item\">Индивидуальная вышивка</li>
\t\t\t\t\t\t<li class=\"footer-grid_item-list_item\">Выезд дизайнера на дом</li>
\t\t\t\t\t\t<li class=\"footer-grid_item-list_item\">Подарочный сертификат</li>
\t\t\t\t\t\t<li class=\"footer-grid_item-list_item\">Заказать образцы ткани</li>
\t\t\t\t\t\t<li class=\"footer-grid_item-list_item\">Программа лояльности</li>
\t\t\t\t\t</ul>
\t\t\t\t</div>
\t\t\t\t<div class=\"footer-grid_item\">
