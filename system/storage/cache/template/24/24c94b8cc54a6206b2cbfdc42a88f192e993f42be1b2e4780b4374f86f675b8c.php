...
class __TwigTemplate_554b4f4f321767ebbbd2ecf4578608f05449d95d5f52833ccfefdb1c38d0a757 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"faq\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["faq"]) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
                // line 24
                echo "                                                ";
                if ((twig_get_attribute($this->env, $this->source, $context["loop"], "first", [], "any", false, false, false, 24) == 1)) {
                    // line 25
                    echo "                                                    укпрукрукр
                                                ";
                }
