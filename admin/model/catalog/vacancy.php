...
class ModelCatalogVacancy extends Model
{
    ...
    public function editVacancy($product_id, $data)
    {
    ...
    public function deleteVacancy($product_id)
    {
    ...
    public function getVacancy($product_id)
    {
    ...
    public function getTotalVacancies($data = array())
    {
