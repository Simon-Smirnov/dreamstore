...
class __TwigTemplate_a30e58e41abc4908c485abb1bc4ecbeb872ee9827c4af852835134fd7065d5c7 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t<ul class=\"footer-grid_item-info_list\">
\t\t\t\t\t\t<li class=\"footer-grid_item-info_list-link\">© ";
        // line 69
        echo ($context["year"] ?? null);
        echo " Dreams Store</li>
\t\t\t\t\t\t<li class=\"footer-grid_item-info_list-link\"><a>Карта сайта</a></li>
\t\t\t\t\t\t<li class=\"footer-grid_item-info_list-link\"><a>Политика конфиденциальности</a></li>
\t\t\t\t\t\t<li class=\"footer-grid_item-info_list-link\"><a>Разработка сайта: <img src=\"";
        // line 72
        echo $this->env->getAssets();
