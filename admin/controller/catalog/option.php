...
class ControllerCatalogOption extends Controller
{
    ...
    protected function getForm()
    {
        ...
        if (isset($this->error['option_value_attention'])) {
            $data['error_option_value_attention'] = $this->error['option_value_attention'];
        } else {
            $data['error_option_value_attention'] = array();
        }
        ...
        foreach ($option_values as $option_value) {
            ...
            $data['option_values'][] = array(
                ...
                'option_value_description_attention' => $option_value['option_value_description_attention'],
                'image' => $image,
        ...
        if (isset($this->request->post['option_value'])) {
            foreach ($this->request->post['option_value'] as $option_value_id => $option_value) {
                foreach ($option_value['option_value_description'] as $language_id => $option_value_description) {
                    ...
                    if ((utf8_strlen($option_value_description['attention']) > 1024)) {
                        $this->error['option_value_attention'][$option_value_id][$language_id] = $this->language->get('error_option_value_attention');
                    }
                }
            }
        }
