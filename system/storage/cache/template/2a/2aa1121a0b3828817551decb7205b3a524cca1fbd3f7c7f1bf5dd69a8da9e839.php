...
class __TwigTemplate_90be14ddd3936dd161f8ef6008f39fd2c46931e6ad17ca7127da61aa76d3926a extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        if (($context["vacancies"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["vacancy"]) {
                ...
                echo "
                                                ...
                                                <td class=\"text-left\">";
                // line 107
                echo twig_get_attribute($this->env, $this->source, $context["vacancy"], "status", [], "any", false, false, false, 107);
                echo "</td>
                                            </tr>
                                        ";
            }
