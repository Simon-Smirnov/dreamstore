...
class __TwigTemplate_acd7b95cbdeac5303a0d93560297e4c96d4f55b4be431e2177fc7b5390c097ea extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"faq\">
        ...
        echo "                        </ul>
                ...
                <div class=\"\">
                    <h2>";
        // line 36
        echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["faqs"] ?? null), 0, [], "any", false, false, false, 36), "name", [], "any", false, false, false, 36);
        echo "</h2>
                    ";
        // line 37
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["faqs"] ?? null), 0, [], "any", false, false, false, 37), "children", [], "any", false, false, false, 37));
        foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
            // line 38
            echo "                        <li class=\"faq-content_list-item\">
                            <h4>";
            // line 39
            echo twig_get_attribute($this->env, $this->source, $context["child"], "title", [], "any", false, false, false, 39);
            echo "</h4>
                            <p>";
            // line 40
            echo twig_get_attribute($this->env, $this->source, $context["child"], "answer", [], "any", false, false, false, 40);
            echo "</p>
                        </li>
                    ";
        }
...
";
    ...
    {
        return array (  180 => 68,  161 => 51,  159 => 50,  157 => 49,  155 => 48,  153 => 47,  151 => 46,  149 => 45,  147 => 44,  145 => 43,  136 => 40,  132 => 39,  129 => 38,  125 => 37,  121 => 36,  115 => 32,  106 => 28,  97 => 25,  93 => 24,  90 => 23,  86 => 22,  81 => 20,  76 => 18,  73 => 17,  69 => 16,  59 => 8,  48 => 6,  44 => 5,  37 => 1,);
    }
