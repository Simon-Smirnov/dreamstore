...
class __TwigTemplate_fe4c664efbb6cc5ab72d214320fcb82043c2b84dc9fdea0b59d7412795557238 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        if (($context["may_be_interest_categories"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["interest_category"]) {
                // line 342
                echo "                        <li>";
                echo twig_get_attribute($this->env, $this->source, $context["interest_category"], "name", [], "any", false, false, false, 342);
                echo "</li>
                    ";
            }
            $_parent = $context['_parent'];
