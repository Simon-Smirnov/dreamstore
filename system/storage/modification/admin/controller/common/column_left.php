...
// CDEK OCMOD START
      ...
      // CDEK OCMOD END
            ...
            if ($this->user->hasPermission('access', 'catalog/reviews')) {
                $catalog[] = array(
                    'name' => $this->language->get('text_reviews'),
            ...
            if ($this->user->hasPermission('access', 'catalog/loyalty')) {
                $catalog[] = array(
                    'name' => $this->language->get('text_loyalty'),
                    'href' => $this->url->link('catalog/loyalty', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }

            if ($this->user->hasPermission('access', 'catalog/colors')) {
                $catalog[] = array(
                    'name' => $this->language->get('text_colors'),
                    'href' => $this->url->link('catalog/colors', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }
