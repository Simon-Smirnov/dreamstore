...
class __TwigTemplate_95ab8d0b35164c4a8aa4047ed8617c254558165bc05585b746ddf2a2ceabc49f extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        if (($context["may_be_interest_categories"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["interest_category"]) {
                ...
                // line 413
                echo twig_get_attribute($this->env, $this->source, $context["interest_category"], "href", [], "any", false, false, false, 413);
                echo "\">
                                <picture>
                                    <source srcset=\"";
                // line 415
                echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["interest_category"], "image", [], "any", false, false, false, 415), "webp", [], "any", false, false, false, 415);
                echo "\">
                                    <img class=\"catalog-inner_link-img\" alt=\"";
                // line 416
                echo twig_get_attribute($this->env, $this->source, $context["interest_category"], "name", [], "any", false, false, false, 416);
                echo "\"
                                         title=\"";
                // line 417
                echo twig_get_attribute($this->env, $this->source, $context["interest_category"], "name", [], "any", false, false, false, 417);
                echo "\"
                                         src=\"";
                // line 418
                echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["interest_category"], "image", [], "any", false, false, false, 418), "default", [], "any", false, false, false, 418);
                echo "\" loading=\"lazy\">
                                </picture>
                                <h4>";
                // line 420
