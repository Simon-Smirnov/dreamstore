...
class ControllerSettingSetting extends Controller
{
    ...
    public function index()
    {
        ...
        if (isset($this->request->post['config_requisites'])) {
            $data['config_requisites'] = $this->request->post['config_requisites'];
        } else {
            $data['config_requisites'] = $this->config->get('config_requisites');
        }
        ...
        if (isset($this->request->post['config_seo_url_slash'])) {
            $data['config_seo_url_slash'] = $this->request->post['config_seo_url_slash'];
        } else {
        ...
        if (isset($this->request->post['config_seo_no_description'])) {
            $data['config_seo_no_description'] = $this->request->post['config_seo_no_description'];
        } else {
